   ...
   @section('doctor.seo')
   <title>Doktorluk ilanını oluştur</title>
   <meta name="description" content="Doktorluk ilanını oluştur" />
   @endsection
   ...
   <div class="container">
       <div class="row">
           <div class="form-doctor-project">
               ...
               <form action="{{ route('doctorcreatesave') }}" method="post" enctype="multipart/form-data">
                   @csrf
                   <div class="form-row">
                       <div class="col">
                   ...
                   <div class="form-row">
                       ...
                       <div class="col">
                           <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="Telefon numarası">
                       </div>
                   </div>

                   <div class="form-group">
                       <input type="number" class="form-control @error('appointment_price') is-invalid @enderror" name="appointment_price" placeholder="Randevu ücreti">
                   </div>

                   <div class="form-group">
                       <textarea type="text" class="form-control @error('my_about') is-invalid @enderror" name="my_about" placeholder="Kendinizi tanıtın"></textarea>
                   </div>
                   ...
                   <div class="input-group mb-3" style="margin-top:10px">
                       <input type="text" name="doctor_date" class="form-control @error('password') is-invalid @enderror" id="daterange" />
                   ...
                   <div class="container" style="margin-top:10px">
                       ...
                       <div class="row">
                           ...
                           @foreach($doctordate as $doctordatekey)
                               ...
                               <div class="input-group mb-3">
                                   <div class="input-group-prepend">
                                       <div class="input-group-text">
                                           <input type="checkbox" name="doctor_time[]" value="{{ $doctordatekey->doctor_time }}" aria-label="Checkbox for following text input">
                                       </div>
                                   </div>
                                   <input type="time" class="form-control" value="{{ $doctordatekey->doctor_time }}">
                               </div>
                           </div>
                           @endforeach
                       </div>
   ...
   <div class="container">
       <div class="row">
           <div class="form-doctor-project">
               ...
               <form action="{{ route('doctorupdate',$doctorprojectkey->user_id) }}" method="post" enctype="multipart/form-data">
                   @csrf
                   <div class="form-row">
                       <div class="col">
