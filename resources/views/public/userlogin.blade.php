...
<meta name="description" content="Doktorlarımız ile görüşebilmek lütfen oturumunuzu açınız." />
@endsection
        ...
        <div class="col-md-7">
            <div class="doctor-login-left-box">
                <div class="doctor-login-left-box-text">
                    <h1>Hemen giriş yap, doktorlardan randevu alın</h1>
                ...
                <div class="doctor-login-left-box-form">
                    <form action="{{ route('userlogin') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" id="inputAddress2" placeholder="Email">
                        </div>
