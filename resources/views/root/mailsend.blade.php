                      ...
                      <tr style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                        <td style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                          ...
                          <div class="in-content" style="margin:0;padding:0;padding:30px;">
                            <h3 style="margin:0;font-family:Helvetica, Arial;line-height:1.4;color:#3f526d;font-weight:500;font-size:20px;margin:20px 0px 15px;padding:0;">Hoş Geldin {{ $doctorname }},</h3>
                            <p style="margin:0;padding:0;font-family:Helvetica, Arial;margin-bottom:10px;font-weight:300;color:#96a6b0;font-size:15px;line-height:1.6;">Merhaba, doktorluk başvurun onaylandı. Haydi! linke tıkla aramıza katıl.</p>
                                        ...
                                        <tr style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                                          <td style="margin:0;padding:0;border-collapse:collapse;border-spacing:0;">
                                            <div style="margin:0;padding:0;text-align: center;width: 100%;">
                                              <a href="http://localhost:8000/doktor-giris" target="_blank" class="cta-button" style="margin:0;padding:0;display:inline-block;background:#8799f6;color:#fff;text-decoration:none;padding:15px 25px;border-radius:5px;font-size:14px;letter-spacing:1px;font-weight:100;margin:20px auto;">Aramıza katıl</a>                                              </div>
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
